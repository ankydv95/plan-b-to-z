...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDF6EC] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl border-2 border-[#EDDFCC] p-8 shadow-sm">
        <h1 className="text-3xl font-bold mb-2" style={{ fontFamily: 'var(--font-lora)' }}>
          Start your journey
        </h1>
        <p className="text-[#9A8B78] mb-8">Free forever. No credit card needed.</p>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-[#5C4E3D] mb-2">Full Name</label>
            <input
              type="text"
              value={fullName}
          ...
          <div>
            <label className="block text-sm font-semibold text-[#5C4E3D] mb-2">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-sm font-semibold text-[#5C4E3D] mb-2">Password</label>
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-[#9A8B78] hover:text-[#5C4E3D]"
              >
        ...
        <p className="text-center text-sm text-[#9A8B78] mt-6">
